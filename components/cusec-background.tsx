  ...
  return (
    <div className="absolute inset-0 overflow-hidden">
      ...
      <motion.div
        ...
        style={{
          background: 'radial-gradient(circle at 20% 50%, rgba(65, 87, 140, 0.6) 0%, transparent 50%)',
        }}
        animate={{
          x: ['-5%', '5%', '-5%'],
          y: ['-3%', '3%', '-3%'],
      ...
      <motion.div
        className="absolute inset-0"
        style={{
          background: 'radial-gradient(circle at 80% 50%, rgba(164, 11, 13, 0.2) 0%, transparent 50%)',
        }}
        animate={{
          x: ['5%', '-5%', '5%'],
          y: ['3%', '-3%', '3%'],
      ...
      <motion.div
        className="absolute inset-0"
        style={{
          background: 'radial-gradient(circle at 50% 30%, rgba(65, 87, 140, 0.4) 0%, transparent 60%)',
        }}
        animate={{
          x: ['0%', '3%', '0%'],
          y: ['0%', '-5%', '0%'],
