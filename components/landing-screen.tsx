        ...
        >
          ...
          >
            <div className="w-full h-full p-1">
              ...
              >
                <Image src="/logo.svg" alt="CUSEC Logo" width={100} height={100} priority />
              </motion.div>
            </div>
          </div>
          ...
          <p 
            className="text-lg text-white/90 mb-6 font-sans"
          >
          ...
          <div className="space-y-4 text-left">
            <div className="border-t border-white/20 pt-4">
              <p className="text-sm text-white/80 mb-4 font-display font-medium">What you'll get:</p>
              <ul 
                className="space-y-2"
              >
                {[
                  ...
                  >
                    ...
                    <span className="text-sm font-sans text-white/90">{item.text}</span>
                  </li>
                ))}
              </ul>
            </div>
